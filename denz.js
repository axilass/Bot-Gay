...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:DOII UCII CANS\n'
            + 'ORG:Owner Dns Bot;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6287861004399:+62 878-6100-4399\n'
            + 'END:VCARD'
...
const vcard1 = 'BEGIN:VCARD\n'
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6281241175244:+62 812-4117-5244\n'
            + 'END:VCARD'
...
memberLimit = 10
ban = []
premium = ["6287861004399@s.whatsapp.net","6281241175244@s.whatsapp.net"]
...
ᴋᴇᴛɪᴋ ${prefix}daftar ᴜɴᴛᴜᴋ ᴍᴇᴍᴜʟᴀɪ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ`
				...
				teks = `ᴀʟʜᴀᴍᴅᴜʟɪʟʟᴀʜ @${num.split('@')[0]}👋\n ᴛᴇʟᴀʜ ᴋᴇʟᴜᴀʀ ɢʀᴜʙ ʙᴀᴄᴀɪɴ ʏᴀsɪɴ ʙɪᴀʀ ᴛᴇɴᴀɴɢ ᴅɪ ᴀʟᴀᴍ sᴀɴᴀ ʟᴀʟᴜ ᴍᴀᴋᴀɴ ɴᴀsɪ ʙᴜɴɢᴋᴜs`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["6287861004399@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["6287861004399@s.whatsapp.net", "6281241175244@s.whataapp.net"] // owner number ubah aja
			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    denz.sendMessage(from, `ᴍᴀᴀғ ᴅᴀᴠɪss ʙᴏᴛ ᴛɪᴅᴀᴋ ʙɪꜱᴀ ᴍᴀꜱᴜᴋ ɢʀᴏᴜᴘ ᴋᴀʀɴᴀ ᴍᴇᴍʙᴇʀ ɢʀᴏᴜᴘ *${groupMetadata.subject}* ᴛɪᴅᴀᴋ ᴍᴇᴍᴇɴᴜʜɪ ʟɪᴍɪᴛ ᴍᴇᴍʙᴇʀ\n\nᴍɪɴɪᴍᴀʟ ᴍᴇᴍʙᴇʀ *${memberLimit}*`, text)
					setTimeout( () => {
		...
		setTimeout( () => {
		reply(`ᴍᴀᴀғ ᴅᴀᴠɪss ʙᴏᴛ ꜱᴇɢᴇʀᴀ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
		}, 0)
		}
        ...
        if (messagesLink.includes("sound14")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound14.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("sound15")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound15.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound16")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound16.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound17")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound17.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound18")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound18.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound19")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound19.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound20")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound20.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound21")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound21.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound22")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound22.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound23")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound23.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound24")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound24.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound25")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound25.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound26")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound26.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound27")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound27.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound28")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound28.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound29")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound29.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound30")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound30.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound31")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound31.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound32")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound32.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound33")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound33.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound34")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound34.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound35")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound35.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound36")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound36.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound37")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound37.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound38")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound38.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound39")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound39.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound40")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound40.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound41")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound41.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound42")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound42.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound43")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound43.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound44")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound44.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound45")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound45.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound46")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound46.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound47")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound47.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound48")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound48.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound49")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound49.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound50")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound50.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound51")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound51.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound52")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound52.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound53")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound53.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound54")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound54.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("sound55")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound55.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound56")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound56.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound57")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound57.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound58")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound58.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound59")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound59.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("sound60")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound60.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound61")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound61.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound62")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound62.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("sound60")){
		denz.updatePresence(from, Presence.composing)
...
if (messagesLink.includes("sound63")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound63.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound64")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound64.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound65")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound65.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound66")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound66.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound67")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound67.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound68")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound68.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound69")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound69.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
if (messagesLink.includes("sound70")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sound70.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (messagesLink.includes("6287861004399")){  // respon tag ubah aja
        reply(`ᴍᴀᴀғ *${pushname2}*, ᴏᴡɴᴇʀ ᴅᴀᴠɪss ʙᴏᴛ ᴛɪᴅᴀᴋ ᴍᴇɴᴇʀɪᴍᴀ ᴛᴀɢ!`)
		...
		reply(`*_「 ʙᴀᴅᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\nᴍᴀᴀғ *${pushname2}* ᴀɴᴅᴀ ʙᴇʀʙɪᴄᴀʀᴀ ᴋᴏᴛᴏʀ!, ᴀɴᴅᴀ ꜱᴇɢᴇʀᴀ ᴅɪᴋɪᴄᴋ ᴅᴀʀɪ ɢʀᴜᴘ *${groupMetadata.subject}*`)
			...
			if (!isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mRECV\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
				...
				case 'menu':
					...
					text:`╭───「 *_ʙᴏᴛ ɪɴғᴏ_* 」
├❏ ᴏᴡɴᴇʀ: ᴅᴀᴠɪss ɢᴀɴᴢ
├❏ sᴜʙsᴄʀɪʙᴇ: https://youtube.com/c/DapissFF
├❏ ᴘʀᴇғɪx: ${prefix}
  ...
  break
			case 'jadian':
              ...
              case 'tupai':
				...
				case 'daftar':
					denz.updatePresence(from, Presence.composing)
					if (isUser) return reply('*ᴋᴀᴍᴜ ꜱᴜᴅᴀʜ ᴍᴇɴᴊᴀᴅɪ ᴛᴇᴍᴀɴ ᴅᴀᴠɪss ʙᴏᴛ :ᴅ*')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
			...
			uptime = process.uptime()
                ...
                const tanggal = `${thisDay}, ${day} - ${myMonths[bulan]} - ${year}`
    				...
    				break 
    case 'infobot':
    				await costum(bottt(prefix), text, DavisGans, botinfo)
    				break
    			case 'profile':
    				denz.updatePresence(from, Presence.composing)
...
case 'husbu':
		...
		if (budy.includes(`Thanks`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, ᴅᴀᴠɪss ᴍɪꜱꜱ ʏᴏᴜ >-<`)
                  }
                  ...
                  reply(`ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname2}*, ᴅᴀᴠɪss ᴅɪꜱɪɴɪ ᴀᴅᴀ ʏᴀɴɢ ʙɪꜱᴀ ᴅɪʙᴀɴᴛᴜ? ᴋᴇᴛɪᴋ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
			      if (budy.includes(`Dns`)) {
                  reply(`ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname2}*, ᴅᴀᴠɪss ᴅɪꜱɪɴɪ ᴀᴅᴀ ʏᴀɴɢ ʙɪꜱᴀ ᴅɪʙᴀɴᴛᴜ? ᴋᴇᴛɪᴋ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
